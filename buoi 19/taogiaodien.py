...
#Button(root, text = "Cộng").grid(row = 2, column = 0)
#Button(root, text = "Trừ").grid(row = 3, column = 0)
...
Button(root, text = "Cộng",command=addNumbers).grid(row = 3, column = 0)
Button(root, text = "Trừ",command=minusNumbers).grid(row = 2,column = 0)
